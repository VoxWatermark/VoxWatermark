...
def decode_audio_files_perturb_whitebox(model, output_dir, args, device, model_name):
    ...
    for watermarked_file in progress_bar:
        ...
        torchaudio.save(os.path.join(save_path, 
            f"{idx}_tau{args.tau}_query{args.iter}_snr{snr:.1f}_acc{acc:.1f}.wav"),
...
def main():
    ...
    decode_audio_files_perturb_whitebox(model, output_dir, args, device, model_name)
